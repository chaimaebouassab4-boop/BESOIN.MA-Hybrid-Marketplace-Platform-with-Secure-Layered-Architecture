...
<?php
// Check if the plugin is active by checking if the function exists
if ( function_exists( 'besoin_api_fetch_data' ) ) {
    $besionSearch = besionSearch(1,'samu',33);
    echo '<pre>';
        // print_r($besionSearch);
    echo '</pre>';
} else {
    // Fallback if the plugin is not active
    echo 'The required API fetching plugin is not activated.';
}
?>
    ...
    <div class="container position-relative">
        ...
        <div id="carouselServices" class="owl-carousel offer-spacing ps-main-section">
            <div class="item ps-box">
                <img src="<?php echo get_template_directory_uri(); ?>/images/ps1.webp" class="d-block img-fluid ps-image" alt="Slide 1">
